...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new org.springframework.security.core.userdetails.User(user.getUsername(), user.getPassword(), mapPermissionToAuthorities(user.getAuthorities()));
    }
    ...
    private Collection<? extends GrantedAuthority> mapPermissionToAuthorities(Collection<Authority> authorities) {
